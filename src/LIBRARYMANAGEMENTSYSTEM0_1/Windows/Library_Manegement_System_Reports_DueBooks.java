 ...
 * @author Anjana
 */
public class Library_Manegement_System_Reports_DueBooks extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Library_Manegement_System_Reports_DueBooks
     */
    public Library_Manegement_System_Reports_DueBooks() {
        initComponents();
    ...
    public void loadalldatatable (){
        try{
            ...
            /*String sql="select B.book_id,B.book_title,B.In_Store,C.customer_id,C.customer_name,C.customer_type,"
                    +"K.keeping_id,K.starting_date,K.due_date,K.issued_user from books_keeping K"
                    +"join books_tb B on K.book_id=B.book_id join customers C on C.customer_id=K.customer_id"
                    +"order by K.keeping_id";            
            */
            String sql="select * from books_keeping";
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Reports For Due Books...");
    ...
    private void txt_searchRKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchRKeyReleased
        ...
        try{
            ...
            String sql="Select * from books_keeping where book_id=?";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        dialog.setSelectedFile(new File("Book_Id "+value+""+"-Due Book Details"+" "+datestring+" "+timestring+".pdf"));
        ...
        if(dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try{
                ...
                String sql="Select keeping_id,customer_id,book_id,starting_date,due_date,issue,issued_user,Accepting_user from books_keeping where book_id='"+value+"'";
                ...
                float[] columnWidths=new float[]{3,3,3,4,4,5,5,5};
                table.setWidths(columnWidths);

                table.setWidthPercentage(100);

                myDocument.add(new Paragraph("------------Library Manegement System-----------",FontFactory.getFont(FontFactory.TIMES_BOLD,25,Font.BOLD)));
                myDocument.add(new Paragraph("Due Book Details...",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD)));
                myDocument.add(new Paragraph(new Date().toString()));
                myDocument.add(new Paragraph("=============================================",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD)));

                table.addCell(new PdfPCell(new Paragraph("Keeping_ID",FontFactory.getFont(FontFactory.TIMES_BOLD,10,Font.BOLD))));
                ...
                table.addCell(new PdfPCell(new Paragraph("Issued_User",FontFactory.getFont(FontFactory.TIMES_BOLD,10,Font.BOLD))));
                table.addCell(new PdfPCell(new Paragraph("Accepting_User",FontFactory.getFont(FontFactory.TIMES_BOLD,10,Font.BOLD))));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JFileChooser dialog=new JFileChooser();
        dialog.setSelectedFile(new File(value+" Books"+""+"-Due Details"+" "+datestring+" "+timestring+".pdf"));
        int dialogResult=dialog.showSaveDialog(null);
        if(dialogResult==JFileChooser.APPROVE_OPTION){
            String filepath = dialog.getSelectedFile().getPath();
            ...
            try{
                ...
                String sql="Select keeping_id,customer_id,book_id,starting_date,due_date,issue,issued_user,Accepting_user  from books_keeping";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Library_Manegement_System_Reports_DueBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Library_Manegement_System_Reports_DueBooks().setVisible(true);
            }
        });
    }
